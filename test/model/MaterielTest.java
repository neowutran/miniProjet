...
public class MaterielTest {
    ...
    public void testEquals() throws Exception{
        ...
        Equipment m1 = new Equipment("Tablette",lc1);
        Equipment m2 = new Equipment("Tablette", lc1);
        Equipment m3 = new Equipment("Tablette", lc1);
        Equipment m4 = new Equipment("Telephone", lc1);
        Equipment m5 = new Equipment("Tablette", lc2);
        Equipment m6 = new Equipment("Tablette", lc3);
    ...
    public void testConstructor() throws Exception {
        ...
        try {
            materiel = new Equipment("Tablette", null);
            //BON
        } catch (Exception e) {
            //Pas BON
        ...
        try{
            materiel = new Equipment("Tablette", caracteristiques);
        }catch (Exception e){
            Assert.assertThat(true, CoreMatchers.equalTo(false));
            //PAS BON
        ...
        try{
            materiel = new Equipment("Casque", caracteristiques);
            Assert.assertThat(true, CoreMatchers.equalTo(false));
            //PAS BON
